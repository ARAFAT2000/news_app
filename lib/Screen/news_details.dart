                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        ModiFyText(text: 'Full Coverage', size: 15)
                      ],
                    ),
                    SizedBox(
                      height: 20,
                    ...
                    Container(
                      ...
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(15),  // Match this with the Container's borderRadius
                        child: Image.network(
                   ...
                   ModiFyText(text: widget.newsdecs.description.toString(), size: 15),
                    SizedBox(
                      height: 20,
                    ),
                    Text('Previous News',style: TextStyle(
                        color: Colors.red,
                        fontSize: 20,
                      fontWeight: FontWeight.bold
                    )),
